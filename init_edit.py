...
def initiator(request):
  ...
  if request.args and 'dataset_name' in request.args and 'no_of_nodes' in request.args and 'no_of_iter' in request.args and 'choice' in request.args and 'if_ones' in request.args and 'c' in request.args and 'factor' in request.args and 'variety' in request.args and 'd' in request.args:
  ...
  elif request_json and 'no_of_nodes' in request_json and 'dataset_name' in request_json and 'no_of_iter' in request_json and 'choice' in request_json and 'if_ones' in request_json and 'c' in request_json and 'factor' in request_json and 'variety' in request_json and 'd' in request_json:
    ...
    return f'Appropriate parameters not given. \'d\', \'variety\', \'factor\', \'c\', \'if_ones\', \'no_of_iter\', \'choice\', \'dataset_name\' and \'no_of_nodes\' need to be given.'
